...
//------------------------------------------------------------------------
// ArpeggigatorProcessor
//------------------------------------------------------------------------
ArpeggigatorProcessor::ArpeggigatorProcessor ()
{
	//--- set the wanted controller for our processor
	setControllerClass (kArpeggigatorControllerUID);
}
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::initialize (FUnknown* context)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::terminate ()
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::setActive (TBool state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::process (Vst::ProcessData& data)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::setupProcessing (Vst::ProcessSetup& newSetup)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::canProcessSampleSize (int32 symbolicSampleSize)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::setState (IBStream* state)
{
...
//------------------------------------------------------------------------
tresult PLUGIN_API ArpeggigatorProcessor::getState (IBStream* state)
{
